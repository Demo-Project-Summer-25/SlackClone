...
public class CardController {
    ...
    public ResponseEntity<BoardResponse> createCard(@PathVariable Long columnId,
    ...
    public ResponseEntity<BoardResponse> updateCard(@PathVariable Long cardId,
                                                    @Valid @RequestBody CardUpdateRequest request) {
        return ResponseEntity.ok(cardService.update(cardId, request));
    }

    @DeleteMapping("/cards/{cardId}")
    public ResponseEntity<BoardResponse> deleteCard(@PathVariable Long cardId) {
